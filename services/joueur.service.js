...
class JoueurServices {
    ...
    static async registerJoueur(username, email, mot_de_passe, nom, telephone, age, poste, wilaya, photo, commune,prenom) {
        try {
            console.log("-----Email --- Password-----", email, mot_de_passe, nom, telephone, age, poste, wilaya, photo, commune,prenom);

            const createJoueur = new joueur({ username, email, mot_de_passe, nom, telephone, age, poste, wilaya, photo, commune,prenom });
